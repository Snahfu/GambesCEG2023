...
<html lang="en">
  ...
  <body style="background: url('{{ asset('assets') }}/background/background.png') center / cover no-repeat fixed">
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="width: 90%;border-radius: 20px;">
            ...
            <div class="card p-0">
              ...
              <div class="card-body">
                <div class="row d-flex justify-content-center mb-4 pt-4" style="text-align: center; font-weight: bold;">
                    ...
                    <div class="col-2">
                        <button type="button" class="btn btn-info px-3 mx-1 text-white"style="background-color: #25683f">Cek</button>
                        <button type="button" class="btn btn-info mx-1 text-white"style="background-color: #25683f">Reset</button>
                    </div>
                </div>
              </div>
              {{-- End Body --}}
