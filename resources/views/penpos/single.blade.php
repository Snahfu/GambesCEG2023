                    ...
                    <div class="d-flex mb-4 pt-4" id="isi-card">
                        ...
                        <div class="my-2 centering-v">
                            <div class="selection w-100">
                                <select name="team[]" id="team1" class="selectpicker bordered"  data-live-search="true"  tabindex="-1" aria-label="team">
                                    <option value ="-" selected hidden>--Pilih Pemain 1--</option>
                                    {{-- semua team yang belum main di pos ini --}}
                                    @foreach ($teams as $team)
                                        <option value="{{ $team->id }}"  data-tokens="{{ $team->nama }}">{{ $team->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
